...
def validate_sdist(path: Path, version: str) -> None:
    ...
    with tarfile.open(path, "r:gz") as archive:
        ...
        required = {
            ...
            f"{root}/docs/assets/empagliflozin-ceac.png",
            f"{root}/docs/assets/empagliflozin-results.json",
            f"{root}/docs/assets/empagliflozin-scenario-icers.png",
            f"{root}/docs/assets/empagliflozin-tornado.png",
            ...
            f"{root}/scripts/generate_readme_assets.py",
